...
- [vue](https://br.vuejs.org/): Framework progressivo para a construção de interfaces de usuário; Framework JS utilizado no desenvolvimento do front-end.
- [React Native](https://reactnative.dev/): Framework JS utilizado na portabilidade para mobile;
...
- [Python](https://www.python.org/): Linguagem de programação de alto nível; Utilizada na criação do modelo de Machine Learning.
...
- [prometheus](https://prometheus.io/): Ferramenta Open Source de monitoramento; Utilizado na aplicação Spring.
- [Mongo](https://www.mongodb.com/): Banco de dados não relacional, baseado em documentos; Utilizado para alimentação dos dados do Prometheus.
